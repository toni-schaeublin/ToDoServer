...
public class ClientView {
	...
	public TextField createUserTxt = new TextField();
	private Label createPasswordLbl = new Label("Bitte geben sie ein Passwort ein:");
	public TextField createPasswordTxt = new TextField();
	public Button createUserBtn = new Button("Account erstellen");
	...
	public TextField ipTxt = new TextField();
	private Label portLbl = new Label("Bitte geben sie die Port-Nummer ein:");
	public TextField portTxt = new TextField();
	public Button connectBtn = new Button("Verbinden");
	public Button pingBtn = new Button("Ping");
	...
	public TextField titleTxt = new TextField();
	public TextField priorityTxt = new TextField();
	public TextField dueDateTxt = new TextField();
	public TextArea descriptionTxt = new TextArea();
	public Button createToDoBtn = new Button("To Do erstellen");
	public Button deleteToDoBtn = new Button("To Do löschen");
	public Button listToDoBtn = new Button("To Do's auflisten");
	public Label statusLbl = new Label("Status");
